...
* `Automatic Speech Recognition (ASR) <https://docs.nvidia.com/deeplearning/nemo/user-guide/docs/en/main/asr/intro.html>`_
    * Latest ASR models
        * canary-1b (`model <https://huggingface.co/nvidia/canary-1b>`_) (`HF space <https://huggingface.co/spaces/nvidia/canary-1b>`_)
        * parakeet-tdt-1.1b (`model <https://huggingface.co/nvidia/parakeet-tdt-1.1b>`_) (`HF space <https://huggingface.co/spaces/nvidia/parakeet-tdt-1.1b>`_)
